...
public final class CraftEvil {
    ...
    public static Material getType(Block block) {
        return CraftLegacyMaterials.toLegacyMaterial(((CraftBlock) block).getNMS());
    }

    public static Material getType(BlockState block) {
        return CraftLegacyMaterials.toLegacyMaterial(((CraftBlockState) block).getHandle());
    }
    ...
    public static int getId(Material material) {
        return CraftLegacyMaterials.toLegacy(material).getId();
    }
