...
public class LivingEntityImpl extends CraftEntity implements LivingEntity {
    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector arg1) {
        ...
        if (Snowball.class.isAssignableFrom(projectile)) {
            ...
            ((ThrownEntity) launch).setProperties(getHandle(), getHandle().getPitch(), getHandle().getYaw(), 0.0F, 1.5F, 1.0F); // ItemSnowball
        } else if (Egg.class.isAssignableFrom(projectile)) {
            launch = new EggEntity(world, getHandle());
            ((ThrownEntity) launch).setProperties(getHandle(), getHandle().getPitch(), getHandle().getYaw(), 0.0F, 1.5F, 1.0F); // ItemEgg
        } else if (EnderPearl.class.isAssignableFrom(projectile)) {
            launch = new EnderPearlEntity(world, getHandle());
            ((ThrownEntity) launch).setProperties(getHandle(), getHandle().getPitch(), getHandle().getYaw(), 0.0F, 1.5F, 1.0F); // ItemEnderPearl
            ...
            ((PersistentProjectileEntity) launch).setProperties(getHandle(), getHandle().getPitch(), getHandle().getYaw(), 0.0F, 3.0F, 1.0F); // ItemBow
            ...
            ((ThrownEntity) launch).setProperties(getHandle(), getHandle().getPitch(), getHandle().getYaw(), -20.0F, 0.5F, 1.0F); // ItemSplashPotion
        } else if (ThrownExpBottle.class.isAssignableFrom(projectile)) {
            launch = new ExperienceBottleEntity(world, getHandle());
            ((ThrownEntity) launch).setProperties(getHandle(), getHandle().getPitch(), getHandle().getYaw(), -20.0F, 0.7F, 1.0F); // ItemExpBottle
